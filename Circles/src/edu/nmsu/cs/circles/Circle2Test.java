...
public class Circle2Test
{
    ...
    {
        Circle2 cir1 = new Circle2(1,1,1.0);
        System.out.println("Running test checkIntersect part 1");
        Assert.assertTrue("This was a Triumph./n", circle2.intersects(cir1));
        Circle2 cir2 = new Circle2(5, 6, 1);
        System.out.println("Running test checkIntersect part 2");
        Assert.assertFalse("This was a Triumph./n", circle2.intersects(cir2));
    }

    // public static void main(String args[]) {
    //     try {
    //         org.junit.runner.JUnitCore.runClasses(java.lang.Class.forName("Circle2Test"));
    //     } catch (Exception e) {
